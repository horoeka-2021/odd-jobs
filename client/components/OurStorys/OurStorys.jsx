    ...
    <div className="mx-auto mb-20">
      <div className="flex flex-row self-center w-full relative">
        ...
        <div className="ourstory-text">
          <h2 className="text-6xl font-weight: 700 font-bold">OUR STORY</h2>
        </div>
      </div>
      <div className="mx-0 mx-auto my-20 text-center max-w-screen-2xl">
        <div className="w-3/4 mx-0 mx-auto pt-10">
          <h2 className="text-4xl font-weight: 700 font-bold">Everyone support the Odd Jobs community!</h2>
          <h2 className="text-2xl font-weight: 700 font-bold">E tautoko ana tatou i te Roopū Odd Jobs</h2>
          <p className="pt-5 leading-loose text-center">
            As a recent graduate in Web Development, OddJobs founder and product owner Nathan
        ...
        <div className="container mx-auto mb-20 mt-16 pt-10">
        ...
        <div className="container mx-auto pt-10">
          <h2 className="text-5xl font-weight: 700 font-bold">OUR TEAM</h2>
        </div>
        ...
        <div className="grid grid-cols-3 gap-8 pt-5">
          ...
          <div>
            ...
            <a href="http://www.linkedin.com/in/goretti-alani-a63a2a226" className="no-underline"
          ...
          <div>
            ...
            <a href="https://www.linkedin.com/in/nickycaparas/" className="no-underline" target="_blank" rel="noreferrer">
              <img src="../img/linked.webp" className="max-h-10 inline"/></a>
          </div>
          ...
          <div className="col-span-3 text-center">
            ...
            <a href="https://www.linkedin.com/in/tommy-yoon-583431227/" className="no-underline" target="_blank" rel="noreferrer">
              <img src="../img/linked.webp" className="max-h-10 inline"/></a>
          </div>
